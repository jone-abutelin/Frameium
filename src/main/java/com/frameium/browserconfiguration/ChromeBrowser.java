...
package com.frameium.browserconfiguration;
...
public class ChromeBrowser {
	...
	public WebDriver getChromeDriver(ChromeOptions cap) {
		...
		if (System.getProperty("os.name").contains("Mac")){
			...
			System.setProperty("webdriver.chrome.driver", ResourceHelper.getResourcePath("src/main/resources/drivers/ChromeForWindows/chromedriver.exe"));
			return new ChromeDriver(cap);
		}
